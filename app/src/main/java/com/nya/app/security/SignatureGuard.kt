...
object SignatureGuard {
    ...
    private val XOR_KEY = byteArrayOf(
        0x5A, 0x39, 0x71, 0xC2, 0x18, 0x4D, 0xE6, 0x8F,
        0x3B, 0x27, 0x91, 0xA4, 0x5C, 0xD3, 0x6E, 0x12,
        0xF8, 0x44, 0xB7, 0x90, 0x33, 0x65, 0xCC, 0x1D,
        0xAF, 0x2B, 0x78, 0xE9, 0x50, 0x14, 0xDB, 0x63
    )
